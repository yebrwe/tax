...
- 대상자는 가족 링크에서 이름을 고르고 파일만 업로드
- 가족은 요청서류에 파일을 업로드하고, 세무사는 같은 작업방에서 파일 링크를 열어 다운로드
...
루트 주소로 접속하면 `세무사`와 `일반 사용자` 진입 화면이 먼저 표시됩니다. 세무사는 설정 후 `가족 링크 복사` 버튼으로 가족용 링크를 공유합니다.
